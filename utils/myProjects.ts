...
import ElDoradoTablet from "../public/assets/images/projects/El-dorado-app/tablet.jpg";
...
const myProjects: myProjects[] = [
  {
    ...
    googlePlayStoreLink:
      "https://play.google.com/store/apps/details?id=io.eldorado.app",
    appleAppStoreLink:
      "https://apps.apple.com/app/el-dorado-marketplace/id1591303547",
    isAppInProd: true,
    skillsUsed: [skillName.Flutter, skillName.Dart, skillName.Firebase],
  },
  {
